...
class MaskPointCloudExtractor:
    ...
    def __init__(self, camera: RealSenseCamera, kin_helper):
        ...
        self.tracker = None
        self.CONTROL_OBJECT_NAMES = ["yellow box"]
        self.TARGET_OBJECT_NAMES = ["blue cup", "white basket"]
...
class RM65Inference:
    def __init__(
        ...
        self.extractor.init_tracker(
            api_token="2f3415c0663079bbd1e2b3aa20b295c6",
            prompt_text="white basket.blue cup.yellow box.",
